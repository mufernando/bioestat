...
data(iris) # carrega os dados
iris # olhe o conteudo do objeto iris  
names(iris) # olhe os nomes dentro do objeto iris
class(iris) # mostra a classe a que pertence o objeto iris 
str(iris)
head(iris)
