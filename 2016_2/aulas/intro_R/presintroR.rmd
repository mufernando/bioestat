...
author: "Bárbara Costa, Murillo Rodrigues"
date: "6 a 8 de outubro de 2016"
output:
  beamer_presentation: default
  ioslides_presentation: null
subtitle: Bioestatística
toc: yes
---
...
Atenção: Instale o R e o R Studio no seu computador seguindo o tutorial de instalação que enviamos por e-mail.
...
<span style="color:blue;">library (geomorph)</span>

Loading required package: geomorph

Loading required package: rgl

<span style="color:blue;">library (ggplot2)</span>
